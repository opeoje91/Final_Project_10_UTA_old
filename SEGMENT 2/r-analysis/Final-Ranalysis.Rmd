...
plt_year_summary_season + geom_point() + labs(x="Year", y="Mean_volume", color="Season")#add scatter plot with labels
...
plt_year_summary_quarter <- ggplot(year_summary_quarter,aes(x=Year,y=Mean_volume)) #import dataset into ggplot2

plt_year_summary_quarter + geom_point() + xlab("Year") + ylab("Mean_volume") #add scatter plot with labels
plt_year_summary_quarter <- ggplot(year_summary_quarter,aes(x=Year,y=Mean_volume,color=Quarter)) #import dataset into ggplot2

plt_year_summary_quarter + geom_point() + labs(x="Year", y="Mean_volume", color="Quarter")#add scatter plot with labels
